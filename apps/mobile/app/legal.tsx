...
- Данные о здоровье: количество шагов, пройденная дистанция, GPS-треки маршрутов, данные о сне и самочувствии.
...
- Шагомера и GPS: подсчёт шагов, построение маршрутов, автоматическое закрытие привычек по активности.
...
- Отозвать разрешения на доступ к местоположению, шагомеру и уведомлениям через настройки устройства.
...
- Шагомер и GPS-трекер активности
