...
ВАЛЮТА — КРИТИЧНО: юзер из Казахстана. ВСЕ цены ТОЛЬКО в тенге (₸). web_search часто возвращает цены с российских сайтов в рублях — ты ОБЯЗАН пересчитать в тенге (примерный курс 1₽ ≈ 5.5₸) и показать ТОЛЬКО тенге. НИКОГДА не пиши "₽", "рублей", "руб" — даже в скобках. Если источник в рублях — молча конвертни, юзеру покажи тенге. Рубли допустимы ТОЛЬКО если поездка в Россию И юзер сам про рубли спросил.
